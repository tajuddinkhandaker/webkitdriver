...
static const HashTableValue JSNavigatorTableValues[16] =
{
    ...
    { "geolocation", DontDelete|ReadOnly, (intptr_t)jsNavigatorGeolocation, (intptr_t)0 },
    { 0, 0, 0, 0 }
};
...
JSValue jsNavigatorGeolocation(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSNavigator* castedThis = static_cast<JSNavigator*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
    Navigator* imp = static_cast<Navigator*>(castedThis->impl());
