...
JSC::JSValue JSC_HOST_CALL jsInspectorFrontendHostPrototypeFunctionWindowUnloading(JSC::ExecState*, JSC::JSObject*, JSC::JSValue, const JSC::ArgList&);
...
JSC::JSValue jsInspectorFrontendHostConstructor(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
