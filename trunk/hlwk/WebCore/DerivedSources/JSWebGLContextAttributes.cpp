...
{
    { "alpha", DontDelete, (intptr_t)jsWebGLContextAttributesAlpha, (intptr_t)setJSWebGLContextAttributesAlpha },
    { "depth", DontDelete, (intptr_t)jsWebGLContextAttributesDepth, (intptr_t)setJSWebGLContextAttributesDepth },
    { "stencil", DontDelete, (intptr_t)jsWebGLContextAttributesStencil, (intptr_t)setJSWebGLContextAttributesStencil },
    { "antialias", DontDelete, (intptr_t)jsWebGLContextAttributesAntialias, (intptr_t)setJSWebGLContextAttributesAntialias },
    { "premultipliedAlpha", DontDelete, (intptr_t)jsWebGLContextAttributesPremultipliedAlpha, (intptr_t)setJSWebGLContextAttributesPremultipliedAlpha },
    { 0, 0, 0, 0 }
};
...
JSValue jsWebGLContextAttributesAlpha(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSWebGLContextAttributes* castedThis = static_cast<JSWebGLContextAttributes*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
...
JSValue jsWebGLContextAttributesDepth(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSWebGLContextAttributes* castedThis = static_cast<JSWebGLContextAttributes*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
    WebGLContextAttributes* imp = static_cast<WebGLContextAttributes*>(castedThis->impl());
...
JSValue jsWebGLContextAttributesStencil(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSWebGLContextAttributes* castedThis = static_cast<JSWebGLContextAttributes*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
    WebGLContextAttributes* imp = static_cast<WebGLContextAttributes*>(castedThis->impl());
...
JSValue jsWebGLContextAttributesAntialias(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSWebGLContextAttributes* castedThis = static_cast<JSWebGLContextAttributes*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
    WebGLContextAttributes* imp = static_cast<WebGLContextAttributes*>(castedThis->impl());
...
JSValue jsWebGLContextAttributesPremultipliedAlpha(ExecState* exec, const Identifier&, const PropertySlot& slot)
{
    JSWebGLContextAttributes* castedThis = static_cast<JSWebGLContextAttributes*>(asObject(slot.slotBase()));
    UNUSED_PARAM(exec);
    WebGLContextAttributes* imp = static_cast<WebGLContextAttributes*>(castedThis->impl());
