...
JSC::JSValue jsWebGLActiveInfoSize(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
JSC::JSValue jsWebGLActiveInfoType(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
JSC::JSValue jsWebGLActiveInfoName(JSC::ExecState*, const JSC::Identifier&, const JSC::PropertySlot&);
